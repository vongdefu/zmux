...
> [!NOTE]
> 项目还在快速迭代过程中，并且由于个性化歌曲信息都存在本地，有丢失歌单和收藏的风险，作者正在快马加鞭修复....

## 功能介绍

- 美好音乐： 日推歌单、个性化歌单管理、收藏、历史记录、歌词滚动、播放模式（列表循环、单曲循环、随机播放）……
- 日程管理： slogan管理、任务管理、周报管理、年报管理……
- 习惯跟踪： 贡献图展示、习惯管理、打卡……
- 番茄时钟： 倒计时、 时常设置（工作时长、短休时长、长休时长、长休间隔）……
- ……
